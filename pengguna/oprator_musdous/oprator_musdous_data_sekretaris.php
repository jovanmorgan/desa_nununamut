...
<body translate="no" class="white-content">
    <div class="wrapper">
        <div class="sidebar">
            <div class="sidebar-wrapper badge-success">
                ...
                <ul class="nav">
                    ...
                    <li class="active">
                        <a href="./oprator_musdous_data_sekretaris">
        ...
        <div class="main-panel">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="sekretaris/tambah.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <!-- Form untuk menambahkan atau mengedit data sekretaris -->
                            <form id="form_edit" action="sekretaris/edit.php" method="POST" enctype="multipart/form-data">
                                <input type="hidden" id="editid_sekretaris" name="id_sekretaris">
                                <div class="form-group">
                                    <label for="nama">Nama:</label>
            ...
            <!-- js edit -->
            <script>
                function openEditModal(id_sekretaris, nama, username, password) {
                    // Isi data ke dalam form edit
                    document.getElementById('editid_sekretaris').value = id_sekretaris;
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category">Clik untuk menambah data Sekretaris</p>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    ...
                                                    <!-- Tombol alat_export -->
                                                    <a href="sekretaris/export" target="_blank" class="btn btn-info btn-block" data-toggle="tooltip" data-original-title="Edit user">
                                                        EXPORT DATA
                                                    </a>
                                                </div>
                                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table tablesorter " id="dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            // Query SQL untuk mengambil data dari tabel sekretaris
                                            $query = "SELECT * FROM sekretaris";
                                            ...
                                            $query .= " ORDER BY id_sekretaris DESC";
                                            $result = mysqli_query($koneksi, $query);
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td class='text-center'>
                                                            <button class='btn btn-primary btn-sm' onclick='openEditModal(
                                                                \"" . htmlspecialchars($row['id_sekretaris'], ENT_QUOTES) . "\",
                                                    ...
                                                    echo "<td class='text-center'>
                                                            <button class='btn btn-danger btn-sm' onclick='hapus(\"" . htmlspecialchars($row['id_sekretaris'], ENT_QUOTES) . "\")'>Hapus</button>
                                                        </td>";
                                                    echo "</tr>";
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('form_tambah').addEventListener('submit', function(event) {
                ...
                xhr.open('POST', 'sekretaris/tambah.php', true);
                xhr.onload = function() {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('form_edit').addEventListener('submit', function(event) {
                ...
                var xhr = new XMLHttpRequest();
                xhr.open('POST', 'sekretaris/edit.php', true);
                xhr.onload = function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        xhr.open('POST', 'sekretaris/hapus.php', true);
        ...
        function loadTable() {
            ...
            xhrTable.open('GET', 'sekretaris/load_table.php', true);
            xhrTable.send();
        }
    </script>
