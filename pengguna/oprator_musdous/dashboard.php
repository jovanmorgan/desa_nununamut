...
<head>
    ...
    <title>
        Desa Nununamat | oprator_musdous Dashboard
    </title>
    <!--     Fonts and icons     -->
        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="row">
                    ...
                    <!-- Anggaran Dana -->
                    <div class="col-lg-4">
                        <div class="card card-chart" onclick="location.href='./oprator_musdous_data_anggaran_dana'">
                            <div class="card-header">
                    ...
                    <!-- Program Kerja -->
                    <div class="col-lg-4">
                        <div class="card card-chart" onclick="location.href='./oprator_musdous_data_program_kerja'">
                            <div class="card-header">
                    ...
                    <!-- Kegiatan -->
                    <div class="col-lg-4">
                        <div class="card card-chart" onclick="location.href='./oprator_musdous_data_kegiatan'">
                            <div class="card-header">
                    ...
                    <!-- Realisasi -->
                    <div class="col-lg-4">
                        <div class="card card-chart" onclick="location.href='./oprator_musdous_data_realisasi'">
                            <div class="card-header">
                    ...
                    <!-- Bidang -->
                    <div class="col-lg-4">
                        <div class="card card-chart" onclick="location.href='./oprator_musdous_data_bidang'">
                            <div class="card-header">
                    ...
                    <!-- Rab -->
                    <div class="col-lg-4">
                        <div class="card card-chart" onclick="location.href='./oprator_musdous_data_rab'">
                            <div class="card-header">
