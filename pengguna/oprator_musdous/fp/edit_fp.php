...
$select_query = "SELECT fp FROM oprator_musdous WHERE id_oprator_musdous = '$id_oprator_musdous'";
...
// Update nama gambar di tabel oprator_musdous berdasarkan id_oprator_musdous
$update_query = "UPDATE oprator_musdous SET fp = '$filename' WHERE id_oprator_musdous = '$id_oprator_musdous'";
$update_result = mysqli_query($koneksi, $update_query);

if ($update_result) {
    // Berhasil menyimpan gambar dan update nama gambar di tabel oprator_musdous
