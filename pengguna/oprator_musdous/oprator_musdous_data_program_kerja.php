...
<body translate="no" class="white-content">
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <script>
                function openEditModal(id_program_kerja, nama_program, id_anggaran_dana, tujuan_program,
                    periode_pelaksanaan, id_rab, status) {
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category">Clik untuk mengeksport Usulan Program Kerja</p>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    <!-- Tombol alat_export -->
                                                    <a href="program_kerja/export" target="_blank" class="btn btn-info btn-block" data-toggle="tooltip" data-original-title="Edit user">
                                                        EXPORT DATA
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            if ($result) {
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    if ($row['status'] == "Telah Diverifikasi") {
                                                        ...
                                                        echo "<button class='btn btn-info btn-sm' disabled>Belum Verifikasi</button>";
                                                    }
                                                    echo "</td>";
                                                    echo "</tr>";
