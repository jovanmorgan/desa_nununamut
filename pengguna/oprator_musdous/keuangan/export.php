                            ...
                            <table id="example" class="table align-items-center mb-0 display nowrap">
                                <thead class=" text-primary">
                                    <tr>
                                        ...
                                        <th class="text-center">Sisah Saldo Kas</th>
                                ...
                                <tbody>
                                    ...
                                    if ($result) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            $tanggal_input_data = date('Y-m-d\TH:i', strtotime($tanggal_input));
                                            echo "<tr>";
                                            ...
                                            echo "<td class='text-center'>" . htmlspecialchars($row['sisah_saldo_kas'], ENT_QUOTES) . "</td>";
