                                ...
                                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                                    <div class="photo">
                                        ...
                                        ?>
                                                    ...
                                                    <?php endif; ?>
                                                    <h5 class="title"><?php echo $oprator_musdous['nama']; ?></h5>
                                    </div>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="editDataFp">
                                    <div class="row">
                                        <input type="hidden" class="form-control" name="id_oprator_musdous" id="id_oprator_musdous" value="<?php echo $oprator_musdous['id_oprator_musdous']; ?>">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Nama</label>
                                                <input type="text" class="form-control" placeholder="nama" name="nama" id="nama" value="<?php echo $oprator_musdous['nama']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Username</label>
                                                <input type="text" class="form-control" placeholder="Username" name="username" id="username" value="<?php echo $oprator_musdous['username']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Password</label>
                                                <input type="text" class="form-control" placeholder="Password" name="password" id="password" value="<?php echo $oprator_musdous['password']; ?>">
                                            </div>
                                        </div>
                                    </div>
...
<footer class="footer">
    <div class="container-fluid">
        ...
        <div class="copyright">
            ...
            </script> Dibuat Oleh Fero <i class="tim-icons icon-heart-2"></i>
        </div>
    </div>
</footer>
        </div>
