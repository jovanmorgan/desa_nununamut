...
<body translate="no" class="white-content">
    <div class="wrapper">
        ...
        <div class="main-panel">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="rab/tambah.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="tgl_pelaksanaan">tgl_pelaksanaan Pelaksanaan :</label>
            ...
            <script>
                function openEditModal(id_rab, id_bidang, penggunaan, status, keterangan, tgl_pelaksanaan, tgl_rab,
                    active) {
                    ...
                    document.getElementById('edittgl_rab').value = tgl_rab;
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category">Clik untuk mengeksport data RAB</p>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    <!-- Tombol alat_export -->
                                                    <a href="rab/export" target="_blank" class="btn btn-info btn-block" data-toggle="tooltip" data-original-title="Edit user">
                                                        EXPORT DATA
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <table class="table tablesorter " id="dataTable">
                                        <thead class=" text-primary">
                                            <tr>
                                                ...
                                                <th class="text-center column-fixed">Tanggal Pelaksanaan Pelaksanaan
                                                </th>
