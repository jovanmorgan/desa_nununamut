...
// Jika pengguna sudah masuk, Anda dapat melanjutkan menampilkan halaman oprator_musdous.php seperti biasa
?>
<!DOCTYPE html>
<html lang="en">
...
<body translate="no" class="white-content">
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="javascript:void(0)">Dashboard Oprator Musdous</a>
                    </div>
                            ...
                            <li class="dropdown nav-item">
                                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                                    <div class="photo">
                                        ...
                                        // Periksa apakah session id_oprator_musdous telah diset
                                        if (isset($_SESSION['id_oprator_musdous'])) {
                                            $id_oprator_musdous = $_SESSION['id_oprator_musdous'];

                                            // Query SQL untuk mengambil data oprator_musdous berdasarkan id_oprator_musdous dari session
                                            $query = "SELECT * FROM oprator_musdous WHERE id_oprator_musdous = '$id_oprator_musdous'";
                                            $result = mysqli_query($koneksi, $query);

                                            // Periksa apakah query berhasil dieksekusi
                                            if ($result) {
                                                // Periksa apakah terdapat data oprator_musdous
                                                if (mysqli_num_rows($result) > 0) {
                                                    // Ambil data oprator_musdous sebagai array asosiatif
                                                    $oprator_musdous = mysqli_fetch_assoc($result);
                                        ?>
                                                    <?php if (!empty($oprator_musdous['fp'])) : ?>
                                                        <img class="avatar" src="data_fp/<?php echo $oprator_musdous['fp']; ?>" alt="...">
                                                    <?php else : ?>
                                                        <img class="avatar" src="../../assets/img/anime3.png" alt="Profile Photo">
                                                    <?php endif; ?>
                                                    <h5 class="title">
                                                        <?php echo $oprator_musdous['id_oprator_musdous']; ?>
                                                    </h5>
                                        <?php
                                                } else {
                                                    // Jika tidak ada data oprator_musdous
                                                    echo "Tidak ada data oprator_musdous.";
                                                }
                                            } else {
                                                // Jika query tidak berhasil dieksekusi
                                                echo "Gagal mengambil data oprator_musdous: " . mysqli_error($koneksi);
                                            }
                                        } else {
                                            // Jika session id_oprator_musdous tidak diset
                                            echo "Session id_oprator_musdous tidak tersedia.";
                                        }
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="masyarakat/tambah.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <!-- Form untuk menambahkan atau mengedit data masyarakat -->
                            <form id="form_edit" action="masyarakat/edit.php" method="POST" enctype="multipart/form-data">
                                <input type="hidden" id="editid_masyarakat" name="id_masyarakat">
                                <div class="form-group">
                                    <label for="nama">Nama:</label>
            ...
            <!-- js edit -->
            <script>
                function openEditModal(id_masyarakat, nama, username, password) {
                    // Isi data ke dalam form edit
                    document.getElementById('editid_masyarakat').value = id_masyarakat;
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category">Clik untuk menambah data Masyarakat</p>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    ...
                                                    <!-- Tombol alat_export -->
                                                    <a href="masyarakat/export" target="_blank" class="btn btn-info btn-block" data-toggle="tooltip" data-original-title="Edit user">
                                                        EXPORT DATA
                                                    </a>
                                                </div>
                                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table tablesorter " id="dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            // Query SQL untuk mengambil data dari tabel masyarakat
                                            ...
                                            $query .= " ORDER BY id_masyarakat DESC";
                                            $result = mysqli_query($koneksi, $query);
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td class='text-center'>
                                                            <button class='btn btn-primary btn-sm' onclick='openEditModal(
                                                                \"" . htmlspecialchars($row['id_masyarakat'], ENT_QUOTES) . "\",
                                                    ...
                                                    echo "<td class='text-center'>
                                                            <button class='btn btn-danger btn-sm' onclick='hapus(\"" . htmlspecialchars($row['id_masyarakat'], ENT_QUOTES) . "\")'>Hapus</button>
                                                        </td>";
                                                    echo "</tr>";
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('form_tambah').addEventListener('submit', function(event) {
                ...
                xhr.open('POST', 'masyarakat/tambah.php', true);
                xhr.onload = function() {
                    ...
                    if (xhr.status === 200) {
                        ...
                        if (response === 'success') {
                            ...
                            swal("Nomor Registrasi Salah!",
                                "Nomor Registrasi harus lebih dari 12 karakter", "info");
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('form_edit').addEventListener('submit', function(event) {
                ...
                var xhr = new XMLHttpRequest();
                xhr.open('POST', 'masyarakat/edit.php', true);
                xhr.onload = function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        xhr.open('POST', 'masyarakat/hapus.php', true);
        ...
        function loadTable() {
            ...
            xhrTable.open('GET', 'masyarakat/load_table.php', true);
            xhrTable.send();
        }
    </script>
