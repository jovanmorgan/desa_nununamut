...
<body translate="no" class="white-content">
    <div class="wrapper">
        <div class="sidebar">
            <div class="sidebar-wrapper badge-success">
                ...
                <ul class="nav">
                    ...
                    <li class="active">
                        <a href="./oprator_musdous_data_kepala_desa">
        ...
        <div class="main-panel">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="kepala_desa/tambah.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <!-- Form untuk menambahkan atau mengedit data kepala_desa -->
                            <form id="form_edit" action="kepala_desa/edit.php" method="POST" enctype="multipart/form-data">
                                <input type="hidden" id="editid_kepala_desa" name="id_kepala_desa">
                                <div class="form-group">
                                    <label for="nama">Nama:</label>
            ...
            <!-- js edit -->
            <script>
                function openEditModal(id_kepala_desa, nama, username, password) {
                    // Isi data ke dalam form edit
                    document.getElementById('editid_kepala_desa').value = id_kepala_desa;
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category">Clik untuk menambah data Kepala Desa</p>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    ...
                                                    <!-- Tombol alat_export -->
                                                    <a href="kepala_desa/export" target="_blank" class="btn btn-info btn-block" data-toggle="tooltip" data-original-title="Edit user">
                                                        EXPORT DATA
                                                    </a>
                                                </div>
                                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table tablesorter " id="dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            // Query SQL untuk mengambil data dari tabel kepala_desa
                                            $query = "SELECT * FROM kepala_desa";
                                            ...
                                            $query .= " ORDER BY id_kepala_desa DESC";
                                            $result = mysqli_query($koneksi, $query);
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td class='text-center'>
                                                            <button class='btn btn-primary btn-sm' onclick='openEditModal(
                                                                \"" . htmlspecialchars($row['id_kepala_desa'], ENT_QUOTES) . "\",
                                                    ...
                                                    echo "<td class='text-center'>
                                                            <button class='btn btn-danger btn-sm' onclick='hapus(\"" . htmlspecialchars($row['id_kepala_desa'], ENT_QUOTES) . "\")'>Hapus</button>
                                                        </td>";
                                                    echo "</tr>";
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('form_tambah').addEventListener('submit', function(event) {
                ...
                xhr.open('POST', 'kepala_desa/tambah.php', true);
                xhr.onload = function() {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('form_edit').addEventListener('submit', function(event) {
                ...
                var xhr = new XMLHttpRequest();
                xhr.open('POST', 'kepala_desa/edit.php', true);
                xhr.onload = function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        xhr.open('POST', 'kepala_desa/hapus.php', true);
        ...
        function loadTable() {
            ...
            xhrTable.open('GET', 'kepala_desa/load_table.php', true);
            xhrTable.send();
        }
    </script>
