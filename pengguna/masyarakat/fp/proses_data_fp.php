...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Cek apakah username sudah ada di database
    $check_query_masyarakat = "SELECT * FROM masyarakat WHERE username = '$username' AND id_masyarakat != '$id_masyarakat'";
    ...
    $query = "UPDATE masyarakat SET username='$username', password='$password', nama='$nama' WHERE id_masyarakat='$id_masyarakat'";
