        ...
        <div class="sidebar">
            <div class="sidebar-wrapper badge-success">
                ...
                <ul class="nav">
                    ...
                    <li>
                        <a href="./sekretaris_data_anggaran_dana">
                            <i class="tim-icons icon-coins"></i> <!-- Ikon koin -->
                            <p>Anggaran Dana</p>
                        </a>
                    </li>
                    <li class="active">
                        <a href="./sekretaris_data_program_kerja">
                            <i class="tim-icons icon-notes"></i> <!-- Ikon catatan -->
                            <p>Program Kerja</p>
                        </a>
                    </li>
                    <li>
                        <a href="./sekretaris_data_kegiatan">
                            <i class="tim-icons icon-calendar-60"></i> <!-- Ikon kalender -->
                            <p>Kegiatan</p>
                        </a>
                    </li>
                    <li>
                        <a href="./sekretaris_data_realisasi">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="program_kerja/tambah.php" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="tujuan_program" name="tujuan_program"
                                        required></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="periode_pelaksanaan">periode Pelaksanaan:</label>
                                    <input type="date" class="form-control" id="periode_pelaksanaan"
                                        name="periode_pelaksanaan" required>
                                </div>
                                <div class="form-group">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="update_program_kerja.php" method="POST"
                                enctype="multipart/form-data">
                                <input type="hidden" id="editid_program_kerja" name="id_program_kerja">
                                <div class="form-group">
                                    <label for="editnama_program">Nama Program:</label>
                                    <input type="text" class="form-control" id="editnama_program" name="nama_program"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="editid_anggaran_dana">Anggaran Dana :</label>
                                    <select class="form-control" id="editid_anggaran_dana" name="id_anggaran_dana"
                                        required>
                                        <option value="" selected>Silakan Pilih</option>
                                        <?php
                                        // Menggunakan include untuk menyertakan file koneksi
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="edittujuan_program" name="tujuan_program"
                                        required></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="editperiode_pelaksanaan">Periode Pelaksanaan:</label>
                                    <input type="date" class="form-control" id="editperiode_pelaksanaan"
                                        name="periode_pelaksanaan" required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    <a href="program_kerja/export" target="_blank"
