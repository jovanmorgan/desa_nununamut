...
<body translate="no" class="white-content">
    <div class="wrapper">
        ...
        <div class="main-panel">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="keuangan/tambah.php" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" class="form-control" id="nomor_rekening"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="keuangan/edit.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="nomor_rekening">Nomor Rekening :</label>
                                    <input type="number" min="0" class="form-control" id="editnomor_rekening"
                                        name="nomor_rekening" required>
                                </div>
                                <div class="form-group">
                                    <label for="jenis_transaksi">Jenis Transaksi :</label>
                                    <select class="form-control" id="editjenis_transaksi" name="jenis_transaksi"
                                        required>
                                        <option value="">Pilih Jenis Transaksi </option>
                                        <option value="Pengeluaran">Pengeluaran</option>
                                        <option value="Pemasukan">Pemasukan</option>
            ...
            <!-- js edit -->
            <script>
            function openEditModal(id_keuangan, id_anggaran_dana, tanggal, nomor_rekening, jenis_transaksi, jumlah,
                keterangan) {
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    <a href="keuangan/export" target="_blank"
