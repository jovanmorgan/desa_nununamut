                                ...
                                <tbody>
                                    ...
                                    if ($result) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            } else if ($row['status'] == "Telah Diverifikasi") {
                                                echo "<button class='btn btn-success btn-sm' disabled>Telah Diverifikasi</button>";
                                            } else {
                                                echo "<button class='btn btn-primary btn-sm' onclick='EditStatus(\"" . htmlspecialchars($row['id_program_kerja'], ENT_QUOTES) . "\")'>Verifikasi</button>";
                                            }
                                            echo "</td>";
                                            echo "</tr>";
