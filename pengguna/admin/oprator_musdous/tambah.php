...
$check_query = "SELECT * FROM oprator_musdous WHERE username = '$username'";
...
// Buat query SQL untuk menambahkan data oprator_musdous ke dalam database
$query = "INSERT INTO oprator_musdous (nama, username, password) 
