                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td class='text-center'>
                                                            <button class='btn btn-primary btn-sm' onclick='openEditModal(
                                                                \"" . htmlspecialchars($row['id_realisasi'], ENT_QUOTES) . "\",
                                                                \"" . htmlspecialchars($row['id_kegiatan'], ENT_QUOTES) . "\",
                                                                \"" . htmlspecialchars($row['biaya'], ENT_QUOTES) . "\",
                                                                \"" . htmlspecialchars($row['status'], ENT_QUOTES) . "\"
                                                            )'>Edit</button>
                                                        </td>";
                                                    echo "<td class='text-center'>
                                                            <button class='btn btn-danger btn-sm' onclick='hapus(\"" . htmlspecialchars($row['id_realisasi'], ENT_QUOTES) . "\")'>Hapus</button>
                                                        </td>";
                                                    echo "</tr>";
