                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td class='text-center'>
                                                                <button class='btn btn-primary btn-sm' onclick='openEditModal(
                                                                    \"" . htmlspecialchars($row['id_program_kerja'], ENT_QUOTES) . "\",
                                                                    \"" . htmlspecialchars($row['nama_program'], ENT_QUOTES) . "\",
                                                                    \"" . htmlspecialchars($row['id_anggaran_dana'], ENT_QUOTES) . "\",
                                                                    \"" . $tujuan_program_sambung . "\",
                                                                    \"" . $periode_pelaksanaan_input_data . "\",
                                                                    \"" . htmlspecialchars($row['id_rab'], ENT_QUOTES) . "\"
                                                                )'>Edit</button>
                                                            </td>";
                                                    echo "<td class='text-center'>
                                                                <button class='btn btn-danger btn-sm' onclick='hapus(\"" . htmlspecialchars($row['id_program_kerja'], ENT_QUOTES) . "\")'>Hapus</button>
                                                            </td>";
                                                    echo "</tr>";
