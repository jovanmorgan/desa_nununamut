...
<body translate="no" class="white-content">
    <div class="wrapper">
        ...
        <div class="main-panel">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="oprator_musdous/tambah.php" method="POST"
            ...
            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <!-- Form untuk menambahkan atau mengedit data oprator_musdous -->
                            <form id="form_edit" action="oprator_musdous/edit.php" method="POST"
                                enctype="multipart/form-data">
                                <input type="hidden" id="editid_oprator_musdous" name="id_oprator_musdous">
                                <div class="form-group">
                                    <label for="nama">Nama:</label>
            ...
            <!-- js edit -->
            <script>
            function openEditModal(id_oprator_musdous, nama, username, password) {
                // Isi data ke dalam form edit
                document.getElementById('editid_oprator_musdous').value = id_oprator_musdous;
                                        ...
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    ...
                                                    <!-- Tombol alat_export -->
                                                    <a href="masyarakat/export" target="_blank"
                                ...
                                <div class="table-responsive">
                                    <table class="table tablesorter " id="dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            // Query SQL untuk mengambil data dari tabel oprator_musdous
                                            $query = "SELECT * FROM oprator_musdous";
                                            ...
                                            $query .= " ORDER BY id_oprator_musdous DESC";
                                            $result = mysqli_query($koneksi, $query);
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td class='text-center'>
                                                            <button class='btn btn-primary btn-sm' onclick='openEditModal(
                                                                \"" . htmlspecialchars($row['id_oprator_musdous'], ENT_QUOTES) . "\",
                                                    ...
                                                    echo "<td class='text-center'>
                                                            <button class='btn btn-danger btn-sm' onclick='hapus(\"" . htmlspecialchars($row['id_oprator_musdous'], ENT_QUOTES) . "\")'>Hapus</button>
                                                        </td>";
                                                    echo "</tr>";
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('form_tambah').addEventListener('submit', function(event) {
            ...
            xhr.open('POST', 'oprator_musdous/tambah.php', true);
            xhr.onload = function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('form_edit').addEventListener('submit', function(event) {
            ...
            var xhr = new XMLHttpRequest();
            xhr.open('POST', 'oprator_musdous/edit.php', true);
            xhr.onload = function() {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    xhr.open('POST', 'oprator_musdous/hapus.php', true);
    ...
    function loadTable() {
        ...
        xhrTable.open('GET', 'oprator_musdous/load_table.php', true);
        xhrTable.send();
    }
    </script>
